...
function sortedListByNames(){
let filteredAges = people.filter(item => item.age >= 18);
let listofNames = filteredAges.map(item => item.name);
...
let categoryOfProducts = Object.groupBy(products,({category}) => category);
